                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li>
                                    ...
                                    <a href="/delete_domain">
                                        <i class="fa fa-wrench"></i> <span>Delete Domain</span>
                                    </a>
                                </li>
                    ...
                    <div class="row" style="margin-bottom:5px;">
                        ...
                        <div class="col-md-6">
                            <div class="sm-st clearfix">
                                <span class="sm-st-icon st-blue"><i class="fa fa-file"></i></span>
                        ...
                        <div class="col-md-6">
                            <div class="sm-st clearfix">
                              ...
                              @if($domain_alert_count == 0)
                                <span class="sm-st-icon st-green"><i class="fa fa-exclamation-triangle"></i></span>
                                <div class="sm-st-info">
                                  
                                    <span>{{$domain_alert_count}}</span>
                              ...
                              @if($domain_alert_count > 0)
                                ...
                                <span class="sm-st-icon st-red"><i class="fa fa-exclamation-triangle"></i></span>
                                <div class="sm-st-info">
                                  
                                    <span><a href ="/domain_alert">{{$domain_alert_count}}</span></a>

                                    
                                    <b><a href ="/domain_alert">Click to see domains to be expired.</a></b>  
                                </div>
